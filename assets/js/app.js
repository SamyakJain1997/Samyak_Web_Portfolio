...
window.addEventListener("scroll", () => {
  ...
  jobTitles[0].style.transform = `translateX(calc(50vh - ${offsetY}px))`;
  jobTitles[1].style.transform = `translateX(calc(-90vh + ${offsetY}px))`;
  jobTitles[2].style.transform = `translateX(calc(120vh - ${offsetY}px))`;
